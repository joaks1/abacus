...
START_TEST (test_get_doubles) {
    ...
    ck_assert_msg((abs(get_d_array(dest, 0) - 0.345) < 0.000001),
            "extracted double is %lf, expected %lf",
            get_d_array(dest, 0), 0.345);
    ck_assert_msg((abs(get_d_array(dest, 1) - 156.345) < 0.000001),
            "extracted double is %lf, expected %lf",
            get_d_array(dest, 1), 156.345);
    ck_assert_msg((abs(get_d_array(dest, 2) - 1230.0) < 0.000001),
            "extracted double is %lf, expected %lf",
